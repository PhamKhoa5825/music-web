...
public class RecommendationService {
    ...
    public List<Song> getRecommendationsForUser(Long userId) {
        ...
        List<Song> candidates = genreEntities.isEmpty() ?
                songRepository.findByIsHiddenFalse() :
                songRepository.findByGenresInAndIsHiddenFalse(genreEntities);
    ...
    private Set<Long> getTrendingSongIds() {
        return rankingRepository.findTop10ByRankingDateOrderByRanksAsc(LocalDate.now())
